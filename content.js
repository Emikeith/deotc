const ChurchData = {
    ...
    clergy: [
        { name: "Abba [Name]", title: "Lead Priest", bio: "Spiritual leader providing guidance to our Winnipeg congregation." }
    ],
    services: [
    ...
    // MINISTRIES SUB-MENUS
    ministryHub: "Our Ministry Hub connects the various service committees including Charity and Development.",
    sundaySchool: {
        title: "Sunday School / የሰንበት ትምህርት ቤት",
        text: "Our Sunday School program nurtures children in the teachings of the Church, Orthodox prayers, and the Ge'ez language.",
        image: "https://via.placeholder.com/600x400?text=Sunday+School"
    },
    sponsorship: "Support specific church projects or students in need through our monthly programs.",
    ...
    registrationLinks: {
        ...
        sponsorship: "https://form.jotform.com/YOUR_ID"
    },
